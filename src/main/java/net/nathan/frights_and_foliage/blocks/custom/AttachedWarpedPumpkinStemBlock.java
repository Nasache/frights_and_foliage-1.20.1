...
public class AttachedWarpedPumpkinStemBlock
        extends PlantBlock {
    ...
    public AttachedWarpedPumpkinStemBlock(WarpedGourdBlock gourdBlock, Supplier<Item> pickBlockItem, Settings settings) {
        super(settings);
