...
public class WarpedPumpkinStemBlock
        extends PlantBlock
    ...
    private final WarpedGourdBlock gourdBlock;
    private final Supplier<Item> pickBlockItem;

    public WarpedPumpkinStemBlock(WarpedGourdBlock gourdBlock, Supplier<Item> pickBlockItem, Settings settings) {
        super(settings);
    ...
    public WarpedGourdBlock getGourdBlock() {
