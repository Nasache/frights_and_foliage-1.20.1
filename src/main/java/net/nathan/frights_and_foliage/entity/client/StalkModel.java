...
public class StalkModel<T extends StalkEntity> extends SinglePartEntityModel<T> {
        ...
        public static TexturedModelData getTexturedModelData() {
            ...
            ModelPartData torso = body.addChild("torso", ModelPartBuilder.create().uv(24, 16).cuboid(-3.0F, -10.5F, -1.0F, 6.0F, 11.0F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, -13.5F, 0.0F));

            ModelPartData head = body.addChild("head", ModelPartBuilder.create().uv(28, 29).cuboid(-1.0F, -2.0F, -1.0F, 2.0F, 2.0F, 2.0F, new Dilation(0.0F))
                    .uv(0, 16).cuboid(-3.0F, -8.0F, -3.0F, 6.0F, 6.0F, 6.0F, new Dilation(0.0F))
                    .uv(0, 0).cuboid(-4.0F, -9.0F, -4.0F, 8.0F, 8.0F, 8.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, -24.0F, 0.0F));

            ModelPartData larm = body.addChild("larm", ModelPartBuilder.create().uv(0, 28).cuboid(-0.5F, -1.0F, -1.0F, 1.0F, 20.0F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(3.5F, -23.0F, 0.0F));

            ModelPartData rarm = body.addChild("rarm", ModelPartBuilder.create().uv(6, 28).cuboid(-0.5F, -1.0F, -1.0F, 1.0F, 20.0F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(-3.5F, -23.0F, 0.0F));

            ModelPartData lleg = body.addChild("lleg", ModelPartBuilder.create().uv(20, 29).cuboid(-1.0F, -0.5F, -1.0F, 2.0F, 13.0F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(2.0F, -12.5F, 0.0F));

            ModelPartData rleg = body.addChild("rleg", ModelPartBuilder.create().uv(12, 28).cuboid(-1.0F, -0.5F, -1.0F, 2.0F, 13.0F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(-2.0F, -12.5F, 0.0F));
