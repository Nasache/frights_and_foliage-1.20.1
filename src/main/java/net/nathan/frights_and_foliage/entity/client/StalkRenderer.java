...
public class StalkRenderer extends MobEntityRenderer<StalkEntity, StalkModel<StalkEntity>> {
    private static final Identifier TEXTURE = new Identifier(FrightsAndFoliage.MOD_ID, "textures/entity/stalk/stalk.png");

    public StalkRenderer(EntityRendererFactory.Context ctx) {
        super(ctx, new StalkModel(ctx.getPart(ModEntityModelLayers.STALK)), 0.6f);
