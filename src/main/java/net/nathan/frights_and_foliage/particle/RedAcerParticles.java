...
public class RedAcerParticles extends SpriteBillboardParticle {
    ...
    protected RedAcerParticles(ClientWorld world, double x, double y, double z, SpriteProvider spriteProvider, double xd, double yd, double zd) {
        super(world, x, y, z);
    ...
    public static class Factory implements ParticleFactory<DefaultParticleType> {
        ...
        public Particle createParticle(DefaultParticleType particleType, ClientWorld clientWorld, double x, double y, double z, double xd, double yd, double zd) {
            return new RedAcerParticles(clientWorld, x, y, z, this.sprites, xd, yd, zd);
        }
    }
}
