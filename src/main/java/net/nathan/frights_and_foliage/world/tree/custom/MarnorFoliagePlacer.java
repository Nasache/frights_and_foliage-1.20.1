...
public class MarnorFoliagePlacer extends FoliagePlacer {
    ...
    private void generateMarnorVinesWithRandomLength(TestableWorld world, FoliagePlacer.BlockPlacer placer, Random random, BlockPos foliagePos, int radius) {
    ...
    private void placeVineWithRandomLength(TestableWorld world, FoliagePlacer.BlockPlacer placer, BlockPos vinePos, Random random) {
